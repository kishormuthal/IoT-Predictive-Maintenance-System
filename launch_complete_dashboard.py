...
if __name__ == "__main__":
    ...
    try:
        ...
        from src.presentation.dashboard.health_check import (
            add_health_check,
        ...
        def render_tab(active_tab):
            ...
            try:
                ...
                if active_tab == "overview":
                    ...
                    from src.presentation.dashboard.layouts import (
                        enhanced_maintenance_scheduler,
                    )
                ...
                return dbc.Alert(
                    [
                        html.H4(
                            f"⚠️ Error loading {active_tab} tab",
