                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        html.P([
                            ...
                            html.Span("NASA SMAP/MSL Data", className="badge bg-info me-2"),
                            html.Span("Trained Models", className="badge bg-warning"),
                            html.Span("Clean Architecture", className="badge bg-primary ms-2")
                        ])
                    ], width=10),
                    dbc.Col([
        ...
        def render_tab(active_tab):
            ...
            try:
                if active_tab == "overview":
                    ...
                    from src.presentation.dashboard.layouts.enhanced_forecasting import create_layout
                    return create_layout()

                elif active_tab == "maintenance":
                    from src.presentation.dashboard.layouts.enhanced_maintenance_scheduler import create_layout
                    return create_layout()

                elif active_tab == "work_orders":
                    from src.presentation.dashboard.layouts.work_orders import create_layout
                    return create_layout()

                elif active_tab == "system":
                    from src.presentation.dashboard.layouts.system_performance import create_layout
                    return create_layout()
