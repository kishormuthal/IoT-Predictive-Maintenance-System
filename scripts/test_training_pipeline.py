...
class TrainingPipelineValidator:
    ...
    def test_anomaly_service_integration(self) -> Dict[str, any]:
        ...
        try:
            ...
            logger.info(
                f"Detection result: {result['detection_result']['anomalies_detected']} anomalies, model_status: {result['detection_result']['model_status']}"
            )
    ...
    def test_forecasting_service_integration(self) -> Dict[str, any]:
        ...
        try:
            ...
            logger.info(
                f"Forecast result: {result['forecast_result']['forecast_values_count']} forecast points, model_status: {result['forecast_result']['model_status']}"
            )
