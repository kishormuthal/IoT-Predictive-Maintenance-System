    ...
    try:
        ...
        app.layout = html.Div([
            ...
            dbc.Container([
                dbc.Row([
                    dbc.Col([
                        ...
                        html.P([
                            html.Span("Dashboard Active", className="badge bg-success me-2"),
                            html.Span("12 NASA Sensors", className="badge bg-info me-2"),
            ...
            dbc.Tabs([
                ...
                dbc.Tab(label="Forecasting", tab_id="forecasting", id="tab-forecasting"),
                dbc.Tab(label="Maintenance", tab_id="maintenance", id="tab-maintenance"),
                dbc.Tab(label="Work Orders", tab_id="work_orders", id="tab-work-orders"),
        ...
        def create_overview_tab():
            return dbc.Container([
                ...
                dbc.Alert([
                    ...
                    html.P("Architecture: Clean Architecture with 4 layers (Core, Application, Infrastructure, Presentation)"),
                ], color="info")
            ])
