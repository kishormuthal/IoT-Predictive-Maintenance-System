...
def main():
    ...
    try:
        ...
        app.layout = html.Div([
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        html.P([
                            ...
                            html.Span(f"{len(sensor_ids)} NASA Sensors", className="badge bg-info me-2"),
                            html.Span("Clean Architecture", className="badge bg-warning")
                        ])
                    ], width=8),
                    dbc.Col([
                        html.Div(id="unified-status-panel", className="text-end")
                    ], width=4)
                ])
            ...
            ], id="unified-tabs", active_tab="overview", className="mb-3"),
    ...
    return dbc.Container([
        ...
        dbc.Row([
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        html.H2(len(equipment_list), className="text-primary"),
            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        html.H2(len(sensor_ids), className="text-success"),
                        html.P("Online")
                    ])
                ])
            ], width=3),
...
def create_anomalies_tab(sensor_ids):
    ...
    return dbc.Container([
        ...
        dbc.Alert(f"NASA Telemanom models ready for {len(sensor_ids)} sensors", color="success"),
...
def create_forecasting_tab(sensor_ids):
    ...
    return dbc.Container([
        ...
        dbc.Alert(f"Transformer models ready for {len(sensor_ids)} sensors", color="success"),
