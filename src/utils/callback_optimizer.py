...
class CallbackOptimizer:
    ...
    def _execute_optimized_callback(
        self,
        func: Callable,
        args: tuple,
        kwargs: dict,
    ...
    def _should_use_incremental_update(
        self,
        callback_name: str,
        args: tuple,
        kwargs: dict,
    ...
    def _generate_chart_incremental_update(
        self, last_snapshot: Dict[str, Any], args: tuple, kwargs: dict
    ) -> Dict[str, Any]:
    ...
    def _generate_generic_incremental_update(
        self, last_snapshot: Dict[str, Any], args: tuple, kwargs: dict
    ) -> Dict[str, Any]:
