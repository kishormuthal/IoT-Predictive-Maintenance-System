...
from src.presentation.dashboard.components.alert_system import (
    AlertCategory,
    AlertManager,
    AlertSeverity,
)
...
from src.presentation.dashboard.components.time_controls import (
    TimeControlConfig,
    TimeControlManager,
    TimeRange,
)
                    ...
                    [
                        ...
                        dbc.CardBody(
                            [
                                ...
                                html.P(
                                    "This tab uses advanced layouts from src/presentation/dashboard/layouts/",
...
class UnifiedIoTDashboard:
    ...
    def _initialize_services_safely(self):
        ...
        from src.application.services.training_config_manager import (
    ...
    def _load_all_rich_layouts(self):
        ...
        layouts_to_load = [
            (
                ...
                "overview",
            ),  # ✓ FIXED - IoT Architecture
            (
                "src.presentation.dashboard.layouts.monitoring",
                "monitoring",
            ),  # ✓ FIXED - NASA data
            (
                "src.presentation.dashboard.layouts.anomaly_monitor",
                "anomaly_monitor",
            ),  # ✓ FULL FEATURES - Heatmap, alerts, threshold manager
            (
                "src.presentation.dashboard.layouts.enhanced_forecasting",
                "enhanced_forecasting",
            ),  # ✓ FIXED - Risk matrix, what-if
            (
                "src.presentation.dashboard.layouts.enhanced_maintenance_scheduler",
                "maintenance",
            ),  # ✓ FIXED - Calendar, gantt, optimization
            (
                "src.presentation.dashboard.layouts.work_orders",
                "work_orders",
            ),  # ✓ FULL FEATURES - Complete CRUD
            (
                "src.presentation.dashboard.layouts.system_performance",
                "system_performance",
            ),  # ✓ FIXED - Training hub, model registry
        ]
                            ...
                            [
                                ...
                                html.P(
                                    [
                                        ...
                                        html.Span(
                                            f"{len(self.sensor_ids)} NASA Sensors",
    ...
    def _setup_unified_callbacks(self):
        ...
        def display_tab_content(*args):
            ...
            if not callback_ctx:
                # Default to overview
                return (
                    self._get_tab_content("overview"),
                    "nav-link active",
                    "nav-link",
                    "nav-link",
                    "nav-link",
    ...
    def _get_tab_content(self, tab_name: str):
        ...
        try:
            if tab_name == "overview":
                ...
                try:
                    from src.presentation.dashboard.layouts.work_orders_simple import (
                        create_layout as create_work_orders_simple,
                    )
    ...
    def _create_monitoring_tab(self):
        ...
        return dbc.Container(
            [
                ...
                dbc.Alert(
                    "Use rich layout from src/presentation/dashboard/layouts/monitoring.py for full features",
                    color="info",
                ),
    ...
    def _create_anomalies_tab(self):
        ...
        return dbc.Container(
            [
                ...
                dbc.Alert(
                    "Use rich layout from src/presentation/dashboard/layouts/anomaly_monitor.py for full features",
                    color="info",
                ),
    ...
    def _create_forecasting_tab(self):
        ...
        return dbc.Container(
            [
                ...
                dbc.Alert(
                    "Use rich layout from src/presentation/dashboard/layouts/enhanced_forecasting.py for full features",
                    color="info",
                ),
    ...
    def _create_maintenance_tab(self):
        ...
        return dbc.Container(
            [
                ...
                dbc.Alert(
                    "Use rich layout from src/presentation/dashboard/layouts/enhanced_maintenance_scheduler.py for full features",
                    color="info",
                ),
    ...
    def _create_work_orders_tab(self):
        ...
        return dbc.Container(
            [
                ...
                dbc.Alert(
                    "Use rich layout from src/presentation/dashboard/layouts/work_orders.py for full features",
                    color="info",
                ),
    ...
    def _create_system_performance_tab(self):
        ...
        return dbc.Container(
            [
                ...
                dbc.Alert(
                    "Use rich layout from src/presentation/dashboard/layouts/system_performance.py for full features",
                    color="info",
                ),
                ...
                dbc.Card(
                    [
                        ...
                        dbc.CardBody([create_training_hub_layout()]),
                    ],
                    className="mb-3",
                ),
                ...
                dbc.Card(
                    [
                        ...
                        dbc.CardBody([create_model_registry_layout()]),
                    ],
                    className="mb-3",
                ),
                ...
                dbc.Card(
                    [
                        ...
                        dbc.CardBody([create_system_admin_layout()]),
                    ],
                    className="mb-3",
                ),
            ]
