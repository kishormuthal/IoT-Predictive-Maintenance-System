...
def update_stats_panel(equipment_id, time_range, n_intervals):
    ...
    try:
        ...
        if sensor_data is not None and 'data' in sensor_data and len(sensor_data['data']) > 0:
            values = sensor_data['data'] if isinstance(sensor_data['data'], np.ndarray) else np.array(sensor_data['data'])
        ...
        return [
            html.Div([html.Span("Mean", className="fw-bold me-2"), html.Span(f"{mean_val:.2f}", className="text-muted")], className="mb-2"),
            html.Div([html.Span("Std Dev", className="fw-bold me-2"), html.Span(f"{std_val:.2f}", className="text-muted")], className="mb-2"),
            html.Div([html.Span("Min", className="fw-bold me-2"), html.Span(f"{min_val:.2f}", className="text-muted")], className="mb-2"),
            html.Div([html.Span("Max", className="fw-bold me-2"), html.Span(f"{max_val:.2f}", className="text-muted")], className="mb-2"),
            html.Div([html.Span("Last Update", className="fw-bold me-2"), html.Span(last_time, className="text-muted")], className="mb-2"),
        ]
    except Exception as e:
        logger.error(f"Error updating stats: {e}")
        return [
            html.Div([html.Span("Mean", className="fw-bold me-2"), html.Span("0.00", className="text-muted")], className="mb-2"),
            html.Div([html.Span("Std Dev", className="fw-bold me-2"), html.Span("0.00", className="text-muted")], className="mb-2"),
            html.Div([html.Span("Min", className="fw-bold me-2"), html.Span("0.00", className="text-muted")], className="mb-2"),
            html.Div([html.Span("Max", className="fw-bold me-2"), html.Span("0.00", className="text-muted")], className="mb-2"),
            html.Div([html.Span("Last Update", className="fw-bold me-2"), html.Span(datetime.now().strftime("%H:%M:%S"), className="text-muted")], className="mb-2"),
        ]
