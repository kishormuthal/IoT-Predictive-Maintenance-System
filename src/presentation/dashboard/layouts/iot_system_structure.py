                ...
                html.Div(
                    [
                        ...
                        dcc.RadioItems(
                            ...
                            options=[
                                {
                                    "label": " [SYSTEM] System Overview Dashboard",
                                    "value": "overview",
                                },
                                {
                    ...
                    [
                        ...
                        html.P(
                            [
                                "💡 ",
                                html.Strong("Note:"),
                                " This IoT system uses real NASA SMAP and MSL telemetry data ",
                            ...
                            [
                                ...
                                html.P(
                                    [
                                        ...
                                        f"{details['equipment']} units",
                                        html.Br(),
                                        html.Strong("Sensors: "),
                                        f"{details['sensors']} sensors",
                                        html.Br(),
                                        html.Span(
                                            f"{details['criticality']}",
                                            className=f"badge bg-{criticality_color}",
                                        ),
                                    ],
                                    className="card-text",
                                ),
...
@callback(
    [Output("smap-details", "children"), Output("msl-details", "children")],
