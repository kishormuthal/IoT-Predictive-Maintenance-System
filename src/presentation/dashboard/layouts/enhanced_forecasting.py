...
from src.presentation.dashboard.components.chart_manager import chart_manager
...
class EnhancedForecastingDashboard:
        ...
        return html.Div(
            [
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            [
                                html.H2(
                                    "Enhanced Forecasting & Predictive Analytics",
                ...
                dbc.Tabs(
                    ...
                    id="enhanced-forecast-tabs",
                    active_tab="advanced-forecast",
                ),
                ...
                [
                    html.P(
                        [
                            ...
                            f"{stats.get('horizon', 0)} hours",
                        ]
                    ),
                    html.P(
                        [
                            html.Strong("Model Type: "),
                            stats.get("model_type", "Unknown"),
                        ]
                    ),
                    ...
                    html.P(
                        [
                            ...
                            f"{stats.get('confidence_level', 0.95)*100:.0f}%",
                        ]
                    ),
                ]
            )
        ...
        def update_uncertainty_analysis(forecast_data):
            ...
            return html.Div(
                [
                    html.P(
                        [
                            html.Strong("Epistemic Uncertainty: "),
                            f"{uncertainty.get('epistemic', 0):.4f}",
                        ]
                    ),
                    html.P(
                        [
                            html.Strong("Aleatoric Uncertainty: "),
                            f"{uncertainty.get('aleatoric', 0):.4f}",
                        ]
                    ),
                    html.P(
                        [
                            html.Strong("Total Uncertainty: "),
                            f"{uncertainty.get('total', 0):.4f}",
                        ]
                    ),
                    html.P(
                        [
                            html.Strong("Prediction Std: "),
                            f"{uncertainty.get('prediction_std', 0):.4f}",
                        ]
                    ),
                    html.P(
                        [
                            html.Strong("Assessment Confidence: "),
    ...
    def _generate_mock_forecast_data(self, equipment, component, horizon, model_type):
        ...
        timestamps_hist = pd.date_range(end=datetime.now(), periods=100, freq="H")
