...
from src.presentation.dashboard.components.chart_manager import (
    ChartConfig,
    ChartData,
    ChartType,
    chart_manager,
...
class ForecastView:
    ...
    def create_layout(self) -> html.Div:
        ...
        return html.Div(
            [
                ...
                dbc.Row(
                    [
                        dbc.Col([self._create_forecast_accuracy_card()], width=3),
                        dbc.Col([self._create_prediction_confidence_card()], width=3),
                        dbc.Col([self._create_failure_probability_card()], width=3),
                        dbc.Col([self._create_maintenance_window_card()], width=3),
                    ],
                    className="mb-4",
                ),
                # Main forecast chart
                                                            ...
                                                            [
                                                                dbc.Checklist(
                                                                    ...
                                                                    options=[
                                                                        ...
                                                                        {
                                                                            "label": "Show Anomaly Threshold",
                                                                            "value": "threshold",
                                                                        },
                                                                        {
                                                                            "label": "Show Historical Anomalies",
                                                                            "value": "anomalies",
                                                                        },
                                                                        {
                                                ...
                                                dash_table.DataTable(
                                                    ...
                                                    style_data_conditional=[
                                                        ...
                                                        },
                                                        {
                                                            "if": {
                                                                "column_id": "probability",
                                                                "filter_query": "{probability} > 60 && {probability} <= 80",
                                                            },
                ...
                dbc.ModalBody(
                    [
                        ...
                        dbc.Checklist(
                            ...
                            options=[
                                {
                                    "label": "Show model uncertainty",
                                    "value": "uncertainty",
                                },
                                {
                                    "label": "Show seasonal patterns",
                                    "value": "seasonal",
                                },
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    f" ({new_failure_prob - base_failure_prob:+.1f}%)",
    ...
    def register_callbacks(self, app):
        ...
        def update_forecast_metric_options(equipment_id, sensor_id):
            ...
            try:
                ...
                logger.info(
                    f"[FORECAST] Updated metric options: {len(dash_options)} metrics for {equipment_id}::{sensor_id}"
                )
                return dash_options, default_value
        ...
        def update_forecast_chart(
            ...
            try:
                ...
                logger.info(
                    f"[FORECAST] Updated chart: type={chart_type}, equipment={equipment_id}, sensor={sensor_id}"
                )
                return figure
    ...
    def _generate_sample_forecast_data(
        self,
        equipment_id: str,
        sensor_id: str,
        metric_id: str,
