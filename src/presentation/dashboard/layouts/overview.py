...
try:
    ...
    def optimize_callback(func):
        return func

    def fast_callback(ttl=None):
        return lambda func: func

    def sensor_callback(ttl=None):
        return lambda func: func

    def chart_callback(ttl=None):
        return lambda func: func
...
class OverviewPage:
    ...
    def create_layout(self) -> html.Div:
        ...
        return html.Div(
            [
                ...
                dbc.Row(
                    [
                        dbc.Col([self._create_iot_architecture_card()], width=4),
                        dbc.Col([self._create_alert_summary_card()], width=4),
                        dbc.Col([self._create_work_order_summary_card()], width=4),
                    ],
                    className="mb-4",
                ),
                # Charts row
                            ...
                            [
                                dbc.Card(
                                    [
                                        ...
                                        dbc.CardBody([html.Div(id="activity-feed")]),
                                    ]
                                )
                            ],
                            width=12,
            ...
            [
                ...
                dbc.CardBody(
                    [
                        ...
                        html.Div(
                            id="recent-alerts-mini",
                            children=[
                                self._create_mini_alert(
                                    "Equipment EQ-001 temperature spike",
                                    "2 min ago",
                                    "danger",
                                ),
                                self._create_mini_alert(
    ...
    def create_equipment_status_chart(self) -> go.Figure:
        ...
        if self.data_manager and isinstance(self.data_manager, dict):
            ...
            # Fallback data
            status_data = {"Online": 20, "Error": 3, "Maintenance": 2}
