    ...
    return dbc.Container([
        ...
        dbc.Row([
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        html.H2(id="total-orders", children="0", className="text-primary"),
            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        html.H2(id="pending-orders", children="0", className="text-warning"),
            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        html.H2(id="in-progress-orders", children="0", className="text-info"),
            ...
            dbc.Col([
                dbc.Card([
                    dbc.CardBody([
                        html.H2(id="completed-orders", children="0", className="text-success"),
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                dbc.Button([
                                    ...
                                    "Refresh"
                                ], id='refresh-work-orders-btn', color="primary", className="mt-4")
                            ], width=3)
                        ])
                    ])
                ])
...
def update_stats(n_intervals, n_clicks):
    ...
    try:
        ...
        completed_today = len(df[(df['Status'] == 'COMPLETED') &
