...
from src.presentation.dashboard.components.anomaly_heatmap import (
    anomaly_heatmap_manager,
)
from src.presentation.dashboard.components.model_status_panel import (
    model_status_manager,
)

# Import dashboard components
from src.presentation.dashboard.components.pipeline_status_monitor import (
...
class PipelineDashboard:
    ...
    def create_layout(self) -> html.Div:
        ...
        return html.Div(
            [
                ...
                dbc.Row(
                    [
                        dbc.Col([self._create_processing_rate_card()], width=3),
                        dbc.Col([self._create_pipeline_health_card()], width=3),
                        dbc.Col([self._create_throughput_card()], width=3),
                        dbc.Col([self._create_queue_status_card()], width=3),
                    ],
                    className="mb-4",
                ),
                ...
                dbc.Row(
                    [
                        dbc.Col([self._create_throughput_chart()], width=8),
                        dbc.Col([self._create_data_sources_panel()], width=4),
                    ],
                    className="mb-4",
                ),
                ...
                dbc.Row(
                    [
                        dbc.Col([self._create_anomaly_heatmap_card()], width=9),
                        dbc.Col([self._create_heatmap_summary_card()], width=3),
                    ],
                    className="mb-4",
                ),
                ...
                dbc.Row(
                    [
                        dbc.Col([self._create_model_status_panel_card()], width=9),
                        dbc.Col([self._create_model_summary_card()], width=3),
                    ],
                    className="mb-4",
                ),
                ...
                dbc.Row(
                    [
                        dbc.Col([self._create_performance_metrics_card()], width=6),
                        dbc.Col([self._create_system_status_card()], width=6),
                    ]
                ),
            ]
        )
    ...
    def _create_pipeline_health_card(self) -> dbc.Card:
        ...
        return dbc.Card(
            [
                dbc.CardHeader([html.H5("💚 Pipeline Health", className="mb-0")]),
                dbc.CardBody(
                    [
                        html.Div(
                            [
    ...
    def _create_throughput_card(self) -> dbc.Card:
        ...
        return dbc.Card(
            [
                dbc.CardHeader([html.H5("⚡ Throughput", className="mb-0")]),
                dbc.CardBody(
                    [
                        dbc.Row(
                            [
    ...
    def _create_data_sources_panel(self) -> dbc.Card:
        ...
        return dbc.Card(
            [
                dbc.CardHeader([html.H5("🛰️ Data Sources", className="mb-0")]),
                dbc.CardBody([html.Div(id="data-sources-status")]),
            ]
        )
    ...
    def _create_performance_metrics_card(self) -> dbc.Card:
        ...
        return dbc.Card(
            [
                ...
                dbc.CardBody([html.Div(id="performance-metrics-details")]),
            ]
        )
    ...
    def _create_system_status_card(self) -> dbc.Card:
        ...
        return dbc.Card(
            [
                dbc.CardHeader([html.H5("⚙️ System Status", className="mb-0")]),
                dbc.CardBody([html.Div(id="system-status-details")]),
            ]
        )
    ...
    def _create_heatmap_summary_card(self) -> dbc.Card:
        ...
        return dbc.Card(
            [
                dbc.CardHeader([html.H5("📈 Equipment Summary", className="mb-0")]),
                dbc.CardBody(
                    [
                        html.Div(
                            [
                                ...
                                html.Div(
                                    [
                                        ...
                                        html.Div(
                                            [
                                                dbc.Badge(
                                                    id="normal-status-badge",
                                                    children="Normal: --",
                                                    color="success",
                                                    className="mb-1 w-100",
                                                ),
                                                dbc.Badge(
                                                    id="warning-status-badge",
                                                    children="Warning: --",
                                                    color="warning",
                                                    className="mb-1 w-100",
                                                ),
                                                dbc.Badge(
                                                    id="critical-status-badge",
                                                    children="Critical: --",
                                                    color="danger",
                                                    className="mb-1 w-100",
                                                ),
    ...
    def _create_model_summary_card(self) -> dbc.Card:
        ...
        return dbc.Card(
            [
                dbc.CardHeader([html.H5("📊 Model Overview", className="mb-0")]),
                dbc.CardBody(
                    [
                        html.Div(
                            [
...
def update_pipeline_metrics(n):
    ...
    try:
        ...
        total_processed = (
            ...
            if metrics.total_processed < 1000000
            else f"{metrics.total_processed/1000000:.1f}M"
        )
...
def update_anomaly_heatmap(n):
    ...
    try:
        ...
        fig.update_layout(title="Equipment Anomaly Heatmap - Error", height=500)
        return fig
