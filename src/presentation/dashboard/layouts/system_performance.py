...
from src.presentation.dashboard.components.config_manager import (
    create_config_management_layout,
)
from src.presentation.dashboard.components.model_registry import (
    create_model_registry_layout,
)
from src.presentation.dashboard.components.system_admin import (
    create_system_admin_layout,
)

# Import components from the original tabs
from src.presentation.dashboard.components.training_hub import (
                            ...
                            dbc.CardHeader(
                                [
                                    ...
                                    dbc.Button(
                                        ...
                                        color="light",
                                        size="sm",
                                        id="training-close-btn",
                                        className="float-end",
                                    ),
                                ]
                            ),
                            dbc.CardBody([html.Div(id="training-detailed-content")]),
                        ],
                        className="mb-3",
                    )
                ],
                id="training-detailed-collapse",
                is_open=False,
            ),
                ...
                [
                    dbc.Card(
                        [
                            ...
                            dbc.CardBody([html.Div(id="models-detailed-content")]),
                        ],
                        className="mb-3",
                    )
                ],
                id="models-detailed-collapse",
                is_open=False,
            ),
            # ML Pipeline Details
            dbc.Collapse(
                [
                    dbc.Card(
                        [
                            ...
                            dbc.CardBody([html.Div(id="pipeline-detailed-content")]),
                        ],
                        className="mb-3",
                    )
                ],
                id="pipeline-detailed-collapse",
                is_open=False,
            ),
                ...
                [
                    dbc.Card(
                        [
                            ...
                            dbc.CardBody([html.Div(id="config-detailed-content")]),
                        ],
                        className="mb-3",
                    )
                ],
                id="config-detailed-collapse",
                is_open=False,
            ),
                ...
                [
                    dbc.Card(
                        [
                            ...
                            dbc.CardBody([html.Div(id="admin-detailed-content")]),
                        ],
                        className="mb-3",
                    )
                ],
                id="admin-detailed-collapse",
                is_open=False,
            ),
        ]
    )
...
def update_processing_rate_chart(n):
    ...
    try:
        ...
        fig = go.Figure()
        fig.add_trace(go.Bar(x=hours, y=rates, marker=dict(color="teal")))
...
def register_callbacks(app, services=None):
        ...
        try:
            ...
            models_summary = html.Div(
                [
                    ...
                    html.Small(
                        [html.I(className="fas fa-star me-1"), "5 Production Models"],
                        className="d-block",
                    ),
                    html.Small(
                        [html.I(className="fas fa-history me-1"), "3 Model Versions"],
                        className="d-block",
                    ),
                ]
            )
            ...
            pipeline_summary = html.Div(
                [
                    ...
                    html.Small(
                        [html.I(className="fas fa-bolt me-1"), "Avg Latency: 45ms"],
                        className="d-block",
                    ),
                    html.Small(
                        [html.I(className="fas fa-check-circle me-1"), "99.8% Uptime"],
                        className="d-block",
                    ),
                ]
            )
            ...
            config_summary = html.Div(
                [
                    ...
                    html.Small(
                        [html.I(className="fas fa-sync me-1"), "Auto-sync: Enabled"],
                        className="d-block",
                    ),
                ]
            )
            ...
            admin_summary = html.Div(
                [
                    ...
                    html.Small(
                        [html.I(className="fas fa-memory me-1"), "RAM: 68% (5.4/8GB)"],
                        className="d-block",
                    ),
                    html.Small(
                        [html.I(className="fas fa-microchip me-1"), "CPU: 23%"],
                        className="d-block",
                    ),
                ]
            )
    ...
    @app.callback(
        ...
        [Input("models-expand-btn", "n_clicks"), Input("models-close-btn", "n_clicks")],
    ...
    @app.callback(
        ...
        [Input("config-expand-btn", "n_clicks"), Input("config-close-btn", "n_clicks")],
    ...
    @app.callback(
        ...
        [Input("admin-expand-btn", "n_clicks"), Input("admin-close-btn", "n_clicks")],
