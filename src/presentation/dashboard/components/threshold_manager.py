...
from config.equipment_config import Equipment, get_equipment_list
...
class EquipmentSpecificThresholdManager:
                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.P(
                                    "Dynamic threshold optimization for CRITICAL, HIGH, and MEDIUM priority equipment",
                                ...
                                dbc.Col(
                                    [
                                        ...
                                        dcc.Dropdown(
                                            ...
                                            options=[
                                                {
                                                    "label": "All Spacecraft",
                                                    "value": "all",
                                                },
                                                {
                                                    "label": "SMAP Satellite",
                                                    "value": "SMAP",
                                                },
                                                {
                                                    "label": "MSL Mars Rover",
                                                    "value": "MSL",
                                                },
                                            ],
                                            value="all",
                    ...
                    [
                        ...
                        dbc.ButtonGroup(
                            [
                                dbc.Button(
                                    "Apply Changes",
                                    id="apply-threshold-changes",
                                    color="success",
                                ),
                                dbc.Button(
                                    "Preview Impact",
                                    id="preview-threshold-impact",
                                    color="info",
                                ),
                                dbc.Button(
                                    "Revert Changes",
                                    id="revert-threshold-changes",
                                    color="warning",
                                ),
                            ],
                            className="mt-3",
    ...
    def _create_optimization_recommendations(self) -> dbc.Card:
        ...
        return dbc.Card(
            [
                ...
                dbc.CardBody([html.Div(id="optimization-recommendations-content")]),
            ],
            className="mb-4",
        )
    ...
    def optimize_thresholds_for_equipment(
        self, equipment_id: str, optimization_type: str = "accuracy"
    ...
    def _create_threshold_distribution_chart(self) -> go.Figure:
        ...
        fig = make_subplots(
            ...
            cols=2,
            subplot_titles=(
                "Threshold Distribution by Criticality",
                "Threshold Levels by Subsystem",
            ),
        ...
        for subsystem in df["subsystem"].unique():
            ...
            fig.add_trace(
                go.Box(y=subset["critical_threshold"], name=subsystem, boxpoints="all"),
                row=1,
                col=2,
            )
    ...
    def _optimize_for_accuracy(
        self, config: ThresholdConfiguration, performance_data: Dict[str, Any]
    ) -> Dict[str, float]:
    ...
    def _optimize_for_false_positives(
        self, config: ThresholdConfiguration, performance_data: Dict[str, Any]
    ) -> Dict[str, float]:
    ...
    def _generate_optimization_justification(
        self,
        optimization_type: str,
        old_thresholds: Dict[str, float],
        new_thresholds: Dict[str, float],
