...
from src.forecasting.risk_matrix import (
    RiskLevel,
...
class RiskMatrixDashboardComponent:
    ...
    def create_risk_heatmap_card(self) -> dbc.Card:
        ...
        return dbc.Card(
            [
                dbc.CardHeader([html.H5("Equipment Risk Heatmap", className="mb-0")]),
                dbc.CardBody(
                    [
                        dcc.Graph(
    ...
    def create_full_layout(self) -> html.Div:
        ...
        return html.Div(
            [
                ...
                dbc.Row(
                    [
                        dbc.Col([self.create_risk_matrix_card()], width=8),
                        dbc.Col([self.create_top_risks_table()], width=4),
                    ],
                    className="mb-4",
                ),
                ...
                dbc.Row(
                    [
                        dbc.Col([self.create_risk_heatmap_card()], width=6),
                        dbc.Col([self.create_risk_trends_card()], width=6),
                    ],
                    className="mb-4",
                ),
