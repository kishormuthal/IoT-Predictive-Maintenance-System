...
from src.anomaly_detection.nasa_anomaly_engine import AnomalyResult, nasa_anomaly_engine
from src.data_ingestion.equipment_mapper import SensorSpec, equipment_mapper
...
class EnhancedDetectionDetailsPanel:
    ...
    def analyze_equipment_detection(
        self, equipment_id: str, anomaly_result: AnomalyResult = None
    ) -> EquipmentDetectionSummary:
        """
            ...
            [
                dbc.CardBody(
                    [
                        ...
                        html.P(
                            [
                                html.Strong("Equipment ID: "),
                                summary.equipment_id,
                                " | ",
                                html.Strong("Type: "),
                                summary.equipment_type,
                                " | ",
                                html.Strong("Subsystem: "),
                                summary.subsystem,
                            ],
                        ...
                        dbc.Card(
                            [
                                dbc.CardBody(
                                    [
                                        html.H5(
                                            f"{summary.reconstruction_quality:.1%}",
    ...
    def _calculate_sensor_anomaly_score(
        self,
        current_value: float,
        historical_mean: float,
        historical_std: float,
