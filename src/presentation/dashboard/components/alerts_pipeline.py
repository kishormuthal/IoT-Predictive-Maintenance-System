...
class NASAAlertsManager:
    ...
    def __init__(self):
        ...
        self.alert_thresholds = {
            "SMAP": {"CRITICAL": 0.8, "HIGH": 0.6, "MEDIUM": 0.4, "LOW": 0.2},
            "MSL": {
    ...
    def _generate_smap_alert_content(
        ...
        content_templates = {
            ...
            "Attitude": {
                ...
                "actions": [
                    "Check reaction wheels",
                    "Verify gyroscope readings",
                    "Review star tracker data",
                ],
            },
            "Thermal": {
                ...
                "actions": [
                    ...
                    "Check thermal radiator performance",
            ...
            "Payload": {
                ...
                "actions": [
                    "Calibrate L-band radiometer",
                    "Verify antenna deployment",
                    "Check science data quality",
                ],
            },
        }
        ...
        content_templates = {
            ...
            "Communication": {
                ...
                "actions": [
                    ...
                    "Verify UHF relay",
                    "Review data transmission rates",
                ],
            },
            "Navigation": {
    ...
    def _find_active_alert(self, equipment_id: str) -> Optional[NASAAlert]:
        ...
        for alert in self.active_alerts.values():
            if alert.equipment_id == equipment_id and alert.status in [
                AlertStatus.NEW,
