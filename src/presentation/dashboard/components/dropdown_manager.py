...
class DropdownStateManager:
    ...
    def _load_dependencies(self):
        ...
        try:
            ...
            logger.info("Equipment configuration loaded successfully")
        ...
        try:
            ...
            logger.info("NASA data loader loaded successfully")
        except ImportError as e:
            logger.error(f"Failed to load NASA data loader: {e}")

    def get_equipment_options(
        self,
        include_all: bool = True,
        filter_by_spacecraft: Optional[str] = None,
        filter_by_criticality: Optional[str] = None,
    ) -> List[DropdownOption]:
        """
    ...
    def get_metric_options_for_sensor(
        ...
        try:
            ...
            for metric in self.standard_metrics:
                ...
                if not include_calculated and metric["value"] in [
                    "anomaly_score",
                    "health_score",
                ]:
                    continue
    ...
    def validate_selection(
        ...
        try:
            ...
            validation_result["combination_valid"] = (
                validation_result["equipment_valid"]
                and (not sensor_id or validation_result["sensor_valid"])
                and (not metric_id or validation_result["metric_valid"])
            )
