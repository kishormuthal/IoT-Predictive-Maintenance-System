...
class MetricVisualizer:
    ...
    def plot_forecast_accuracy_by_horizon(
        ...
        # MAE
        fig.add_trace(
            go.Scatter(x=steps, y=mae_by_step, mode='lines+markers', name='MAE',
                      line=dict(color='#2E86AB', width=2)),
            row=1, col=1
        )
        ...
        # RMSE
        fig.add_trace(
            go.Scatter(x=steps, y=rmse_by_step, mode='lines+markers', name='RMSE',
                      line=dict(color='#A23B72', width=2)),
            row=1, col=2
        )
        ...
        # MAPE
        fig.add_trace(
            go.Scatter(x=steps, y=mape_by_step, mode='lines+markers', name='MAPE (%)',
    ...
    def plot_model_health_summary(
        ...
        fig = go.Figure(data=[
            ...
            go.Bar(name='Baseline', x=models, y=baseline_values, marker_color='lightgray')
        ])
